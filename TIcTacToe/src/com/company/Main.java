...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        boolean error = false;
        int[][] board = {{0,0,0},{0,0,0},{0,0,0}}; // Setting Board
        while(!winner && remains){
            ...
            System.out.println("---------");
            for (int i = 0; i < board.length; i++){ // Renders the board based off of the values in the 2d array board.
                for (int j = 0; j < board[i].length; j++){ // 0 is blank, 1 is X, 2 is O.
